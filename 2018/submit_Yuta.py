...
#for prod in ['NonRes']:
#for prod in ['Pair', 'Single']:
    for mp in [600, 800, 1000, 1200, 1400, 1600, 2000]:
#    for mp in [1000]:
        slist = ("test_LegacyRun2_2018_LQ_" + prod + "_5f_Madgraph_LO_M" + str(mp), "/t3home/ytakahas/work/prod/nanoAOD/legacy_Run2_gridpacks/" + prod + "_M" + str(mp) + "_slc6_amd64_gcc630_CMSSW_9_3_8_tarball.tar.xz")
